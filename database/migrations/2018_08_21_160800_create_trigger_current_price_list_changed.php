...
class CreateTriggerCurrentPriceListChanged extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Команда migrate:fresh не очень дружит с чем-то кроме таблиц, поэтому...
        $this->down();

        // Обнявляет статусы бывших "текущих" прайс-листов, применяет новые цены к товарам
        DB::unprepared("
