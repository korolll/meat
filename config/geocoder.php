...
use App\Services\Geocoding\Yandex;
...
return [
    'cache' => [
        ...
        */
        ...
        'store' => env('GEOCODER_CACHE_STORE', 'geocode'),
    ...
    */
    'providers' => [
        Chain::class => [
            GoogleMaps::class => [
                env('GOOGLE_MAPS_LOCALE', 'ru'),
                env('GOOGLE_MAPS_API_KEY'),
            ],
            Yandex::class => [
                env('YANDEX_MAPS_TOPONYM'),
...
//            GeoPlugin::class  => [],
    ...
    */
    ...
    'data' => [
        'bbox' => env('GEOCODER_DATA_BBOX', '43.277970,40.681884~44.447515,42.349396')
    ]
];
