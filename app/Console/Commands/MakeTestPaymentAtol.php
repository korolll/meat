 ...
 * php artisan payments:test-atol 997f03e4-315c-4913-838c-ce2bc116f435 --mode=2
 */
class MakeTestPaymentAtol extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'payments:test-atol {uuid : Client card uuid} 
     ...
     * @var string
     */
    protected $description = 'Тестовый платеж (с ATOL)';
    ...
    public function handle(AcquireInterface $acquireHandler, AtolOnlineClient $atolOnlineClient)
    {
        ...
        switch ($mode) {
            ...
            case 1:
                ...
                if (! $this->refund($orderPaymentId, $totalPrice / 2)) {
                    return;
                }
