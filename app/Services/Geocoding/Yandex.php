 ...
 *
 * Это копия класса (из за final поменять не выйдет)
 * @see \Geocoder\Provider\Yandex\Yandex
 */
class Yandex extends AbstractHttpProvider implements Provider
{
    /**
     * @var string
     */
    ...
    public function geocodeQuery(GeocodeQuery $query): Collection
    {
        ...
        if (null !== $bbox = $query->getData('bbox')) {
            $url = sprintf('%s&rspn=1&bbox=%s', $url, $bbox);
        }
